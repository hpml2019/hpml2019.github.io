...
<tr id="xxtr"><td id="xxtd"><p id="xxp">15:50 16:00</p> </td><td id="xxtd"><p id="xxbold">Closing remarks</p><p id="xxp"><a href="HPML2018closing.pdf">slides</a></p></td></tr>
...
<div id="talk4" class="modal">
  <div class="modal-content">
    ...
    &nbsp;
    <p class="xxblack" id="xxp">The advent of pre-trained language models such as Google’s BERT promises a high performance transfer learning (HPTL) paradigm for many natural language understanding tasks including email classification. This paper conducts an empirical investigation to evaluate transfer learning with pre-trained language models and embeddings for classifying sales engagement emails arising from digital sales engagement platforms. Given the complexity of content and context of sales engagement, lack of standardized large corpus and benchmarks, limited labeled examples and heterogenous context of intent, this real-world use case poses both a challenge and an opportunity for adopting an HPTL approach. We propose an evaluation framework to assess an HPTL in three key areas in addition to commonly used accuracy metrics: 1) effective embeddings and pre-trained language model usage, 2) minimum labeled samples requirement and 3) transfer learning implementation strategies. We use the Outreach corporate sales engagement email samples as the experiment dataset, which includes over 3000 emails labeled as positive, objection, unsubscribe, or not-sure. We discuss our findings on evaluating BERT, Elmo, Flair and GloVe embeddings with both feature-based and fine-tuning based transfer learning implementation strategies and their scalability on a GPU cluster with increasing larger labeled samples. Our results show that a combination of BERT and Flair embeddings works best in the feature-based approach, but the fine-tuning of BERT model outperforms with as few as 300 labeled samples, comparing to the feature-based approach. We point out promising directions on moving towards a HPTL system in the sales engagement domain</p>
  </div>
</div>
